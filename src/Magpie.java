...
public class Magpie {
    ...
    public String getResponse(String statement) {
        ...
        if (statement.length() == 0) {
            return "I don't want to talk to you anyways.";
        }
        String response = "";
        if (findKeyword(statement, "no") >= 0) {
            response = "It doesn't matter if you say no or not.";
        ...
        } else if (findKeyword(statement, "who is joe") >= 0
                || findKeyword(statement, "who's joe") >= 0) {
            response = "Joe Mama.";
    ...
    private String transformIWantStatement(String statement) {
        ...
        return "I think that " + restOfStatement + " is for losers.";
    }
    ...
    private String transformILikeStatement(String statement) {
        ...
        String restOfStatement = statement.substring(psn + 6).trim();
        return "Why would you ever like " + restOfStatement + "?";
    }
